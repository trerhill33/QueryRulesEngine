...
using ApprovalHierarchyManager.Application.Features.ApprovalHierarchy.CreateHierarchy.Validators;
    ...
    private void SetupBasicMocks()
    {
        ...
        _readOnlyRepositoryMock
            .Setup(x => x.FindAllByPredicateAsync<Metadata>(
                ...
                _cancellationToken))
            .ReturnsAsync(new List<Metadata>());
