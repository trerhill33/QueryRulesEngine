...
using QueryRulesEngine.MetadataKeys.TaggedMetadataUpdate;
...
namespace QueryRulesEngine.Tests.Hierarchys.Metadatakeys
{
    ...
    public class TaggedMetadataUpdateServiceTests
    {
        private static class TestData
        {
            ...
            public static readonly List<int> TaggedHierarchyIds = new() { 1, 2, 3 };
        }
        ...
        public async Task UpdateMetadataValueByTag_ValidTag_UpdatesAllTaggedHierarchies()
        {
            ...
            // Act
            var result = await _updateService.UpdateMetadataValueByTagAsync(
                TestData.ApproverId,
