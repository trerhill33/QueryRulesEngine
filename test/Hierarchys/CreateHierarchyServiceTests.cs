        ...
        Mock<IValidator<CreateHierarchyRequest>>? validatorMock = null)
    {
        ...
        public async Task ExecuteAsync_ValidRequest_CreatesHierarchyAndDefaultLevels()
        {
            ...
            _hierarchyRepositoryMock
                .Setup(x => x.CreateHierarchyAsync(request.Name, request.Description, It.IsAny<string>(), It.IsAny<CancellationToken>()))
            ...
            _hierarchyRepositoryMock.Verify(
                x => x.CreateHierarchyAsync(request.Name, request.Description, It.IsAny<string>(), It.IsAny<CancellationToken>()),
                Times.Once);
        ...
        public async Task ExecuteAsync_EmptyName_ReturnsNameRequiredError()
        {
            ...
            _hierarchyRepositoryMock.Verify(
                x => x.CreateHierarchyAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()),
                Times.Never);
